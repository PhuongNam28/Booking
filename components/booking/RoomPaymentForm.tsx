...
function hasOverlap(
  ...
  for (const range of dateRanges) {
    const rangeStart = startOfDay(new Date(new Date(range.startDate)));
    const rangeEnd = endOfDay(new Date(new Date(range.endDate)));
    ...
    try {
      ...
      if (overlapFound) {
        ...
        return toast({
          variant: "destructive",
          description:
            "Oops! Some of the days you are trying to book have already been reserved. Please go back and select different or rooms",
        });
      }
